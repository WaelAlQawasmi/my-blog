                      ...
                      <ul class="timeline">
                        @foreach ($data as $item)
                           ...
                           <div class="timeline-time">
                              <span class="date"> crate: {{$item->created_at}}</span>
                              <span class="time">last update: {{$item->updated_at}}</span>
                           </div>
                           <!-- end timeline-time -->
                           <!-- begin timeline-icon -->
 ...
 <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog">
     <div class="modal-content">
       ...
       <form method="POST" action="{{ route('myPostes.store')}}">
